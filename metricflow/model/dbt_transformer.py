...
class DbtTransformer:
    ...
    def transform(self, dbt_metrics: Tuple[MetricNode, ...]) -> DbtTransformationResult:
        ...
        for rule in self.rules:
            ...
            issues = ModelValidationResults.merge([issues, transformation_rule_issues])

        return DbtTransformationResult(transformed_objects=transformed_objects, issues=issues)
