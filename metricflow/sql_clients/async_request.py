...
class SqlRequestExecutorThread(threading.Thread):
    ...
    def __init__(  # noqa: D
        ...
        Args:
            ...
            tags: Tags that should be associated with the request for the statement.
    ...
    def run(self) -> None:  # noqa: D
        ...
        try:
            statement = SqlStatementCommentMetadata.add_tag_metadata_as_comment(
                self._statement, SqlRequestTagSet().add_request_id(self._request_id)
            )
